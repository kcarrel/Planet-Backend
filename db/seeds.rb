...
Profile.create(user_id: User.all.last.id, email: 'email', name: 'imaname', age: 21, max_age_preference: 30, min_age_preference: 21, pronouns: 'she/her', location: "seattle", image: 'thisisnaimage', biography: 'i am a bio', gender_preference: 'women')

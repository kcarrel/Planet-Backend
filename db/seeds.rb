...
Profile.create(user_id: User.all.last.id, name: 'imaname', age: 21, age_preference: '21 - 22', pronouns: 'she/her', location: "seattle", image: 'thisisnaimage', biography: 'i am a bio', gender_preference: 'women')
